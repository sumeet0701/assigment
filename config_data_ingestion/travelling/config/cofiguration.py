from travelling.entity.config_entity import DataIngestionConfig, TrainingPipelineConfig
from travelling.util.util import read_yaml_file
...
class Configuration:
    def __init__(self, 
        ...
        self.training_pipeline_config= self.get_training_pipline_config()
